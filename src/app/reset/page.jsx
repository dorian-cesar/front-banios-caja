    ...
    const validate = () => {
        if (!token) {
            showNotification({
                ...
                message: "Abre esta página desde el link que llegó a tu correo.",
                duration: 5000,
            });
            return false;
        }
        ...
        try {
            ...
            if (res?.ok) {
                ...
                showNotification({
                    ...
                    message: res?.message || "El enlace puede haber expirado.",
                    duration: 5000,
                });
            }
        } catch (err) {
            ...
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">
                        Ingresa tu nueva contraseña. El enlace es válido por 30 minutos.
                    </p>
                </div>
                ...
                {!token ? (
                    <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 text-center">
                        <p className="text-red-600 font-medium">
                            Enlace inválido o sin token. Abre esta página desde el link del correo.
                        </p>
                    ...
                    >
                        <div className="space-y-5">
                            {/* Nueva contraseña */}
                            <div>
                                <label htmlFor="pw1" className="block text-sm font-medium text-gray-700 mb-1">
                                    Nueva contraseña
                                </label>
